...
@section('title') Read Mail @endsection

@section('headIncludes')
<!-- CSS -->
 <!-- iCheck -->
 <link rel="stylesheet" href="{{ asset('themes/admin/plugins/iCheck/flat/blue.css') }}">
@endsection
...
<section class="content-header">
  <h1>Read Mail <small>Preview...</small></h1>
    ...
    <div class="box box-primary">
      ...
      <div class="box-footer">
        <ul class="mailbox-attachments clearfix">
          ...
          <li>
            <span class="mailbox-attachment-icon has-img"><img src="{{ asset('themes/admin/dist/img/photo1.png') }}" alt="Attachment"></span>
          ...
          <li>
            <span class="mailbox-attachment-icon has-img"><img src="{{ asset('themes/admin/dist/img/photo2.png') }}" alt="Attachment"></span>
