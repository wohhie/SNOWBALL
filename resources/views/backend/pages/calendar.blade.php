...
<!-- CSS -->
 <!-- fullCalendar -->
 <link rel="stylesheet" href="{{ asset('themes/admin/bower_components/fullcalendar/dist/fullcalendar.min.css') }}">
 <link rel="stylesheet" href="{{ asset('themes/admin/bower_components/fullcalendar/dist/fullcalendar.print.min.css') }}" media="print">
@endsection
...
<section class="content-header">
  <h1>Calendar <small>Preview...</small></h1>
...
<!-- Js -->
 ...
 <!-- fullCalendar -->
 <script src="{{ asset('themes/admin/bower_components/moment/moment.js') }}"></script>
 <script src="{{ asset('themes/admin/bower_components/fullcalendar/dist/fullcalendar.min.js') }}"></script>
