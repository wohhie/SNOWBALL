...
@section('title') Inline Charts @endsection
...
<section class="content-header">
  <h1>Inline Charts <small>Preview...</small></h1>
...
<!-- Js -->
 ...
 <!-- jQuery Knob -->
 <script src="{{ asset('themes/admin/bower_components/jquery-knob/js/jquery.knob.js') }}"></script>
 <!-- Sparkline -->
