...
@section('title') Advanced Form Elements @endsection
...
<!-- CSS -->
 ...
 <link rel="stylesheet" href="{{ asset('themes/admin/bower_components/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css') }}">
...
<!-- Js -->
 ...
 <!-- InputMask -->
 <script src="{{ asset('themes/admin/plugins/input-mask/jquery.inputmask.js') }}"></script>
 <script src="{{ asset('themes/admin/plugins/input-mask/jquery.inputmask.date.extensions.js') }}"></script>
 <script src="{{ asset('themes/admin/plugins/input-mask/jquery.inputmask.extensions.js') }}"></script>
 <!-- date-range-picker -->
 ...
 <!-- bootstrap color picker -->
 <script src="{{ asset('themes/admin/bower_components/bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js') }}"></script>
 <!-- bootstrap time picker -->
