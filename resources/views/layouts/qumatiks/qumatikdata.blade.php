                        ...
                        @forelse($qumatikDatas as $index => $data)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else
                                        <a href="{{ route('qumatikdata.location', $data->id) }}" class="btn btn-success btn-xs" data-toggle="tooltip" data-placement="top" title="Location"><i class="fa fa-location-arrow"></i></a>
                                    @endif
                                </td>
                            </tr>
                        @empty
