...
module.exports = function (grunt) {
  ...
  Object.keys(configBridge.paths).forEach(function (key) {
    configBridge.paths[key].forEach(function (val, i, arr) {
      arr[i] = path.join('./docs/adminlte', val);
    });
  });
  ...
  grunt.initConfig({
    ...
    jshint: {
      ...
      assets: {
        src: ['docs/adminlte/js/src/*.js', 'docs/adminlte/js/*.js', '!docs/adminlte/js/*.min.js']
      }
    },
    ...
    uglify: {
      ...
      customize: {
        ...
        dest: 'docs/adminlte/js/customize.min.js'
      },
      docs: {
        src: configBridge.paths.docsJs,
        dest: 'docs/adminlte/js/docs.min.js'
      }
    },
    ...
    less: {
      ...
      docs: {
        options: {
          ...
          sourceMapFilename: 'docs/adminlte/css/docs.css.map'
        },
        src: 'docs/adminlte/less/docs.less',
        dest: 'docs/adminlte/css/docs.css'
      },
      docsIe: {
        options: {
          sourceMap: false
        },
        src: 'docs/adminlte/less/ie10-viewport-bug-workaround.less',
        dest: 'docs/adminlte/css/ie10-viewport-bug-workaround.css'
      }
    },
    ...
    postcss: {
      ...
      docs: {
        src: 'docs/adminlte/css/docs.css'
      },
      examples: {
        options: {
          map: false
    ...
    cssmin: {
      ...
      docs: {
        src: 'docs/adminlte/css/docs.css',
        dest: 'docs/adminlte/css/docs.min.css'
      }
    },
  ...
  grunt.registerTask('lint-docs-js', ['jshint:adminlte', 'jscs:adminlte']);
